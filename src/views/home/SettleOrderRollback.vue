<template>
    <van-dialog v-model:show="isShow" title="撤销订单结算" show-cancel-button @closed="closed(false)" @confirm="settleClick">
            ...
            <div class="settle_card">
                ...
                <van-row>
                    ...
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;">
                        <input v-model="fromData.weight">
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="12">
                        <span class="remark">请输入结算价(豆)</span>
                    </van-col>
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;">
                        <input v-model="fromData.finish_price">
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="8">
                ...
                <van-row>
                    <van-col span="12">
                        <span class="remark">请输入结算时间</span>
                    </van-col>
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;">
                        <span @click="clickSelectFinishDate">{{ formatDate(fromData.finish_at, "yyyy-MM-DD HH:mm:ss")
                        }}</span>
                    </van-col>
                </van-row>
                <van-row>
                    ...
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;">
                        <input v-model="fromData.rollback_reason">
                    </van-col>
                </van-row>
            </div>
        </div>
...
import { settleOrderRollback } from '../../service/order.js'
    ...
    methods: {
        ...
        settleClick() {
            settleOrderRollback({
                ...
                finish_at: this.fromData.finish_at,
        ...
        confirmSelectDate(date) {
            this.currentDate = moment(date, 'yyyy-MM-DD HH:mm:ss').toDate();
            this.fromData.finish_at = formatDate(date, 'YYYY-MM-DD HH:mm:00')
