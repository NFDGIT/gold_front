<template>
    <van-dialog v-model:show="isShow" title="结算玩家订单" show-cancel-button @closed="closed(false)" @confirm="settleClick">
        <div class="settle_content">
            <div class="settle_card">
                ...
                <van-row>
                    <van-col span="8">
                        <span class="remark">用户</span>
                    </van-col>
                    <van-col span="16" calss="right" style="text-align: right;padding-right: 10px;">
                        <!-- <input v-model="formData.book_price"> -->
                        <span class="blod">{{ fromData.user_name }}</span>
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="8">
                    ...
                    <van-col span="16" calss="right" style="text-align: right;padding-right: 10px;">
                        <!-- <input v-model="formData.book_price"> -->
                        <span class="blod">{{ fromData.weight }}</span>
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="8">
                ...
                <van-row>
                    ...
                    <van-col span="16" calss="right" style="text-align: right;padding-right: 10px;">
                        <!-- <input v-model="formData.book_price"> -->
                        <span class="blod">{{ fromData.deposit }}</span>
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="8">
                ...
                <van-row>
                    <van-col span="12">
                        <span class="remark">请输入结算克重</span>
                    </van-col>
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;">
                        <input v-model="fromData.split_weight" @change="profitCipher" @keyup="profitCipher">
                    </van-col>
                </van-row>
            </div>
        </div>
...
import { settleOrderDetail } from '../../service/order.js'
...
export default {
    ...
    created() {
        ...
        this.fromData.split_weight = this.fromData.weight-this.fromData.split_weight
    ...
    methods: {
        ...
        settleClick() {
            settleOrderDetail({
                ...
                split_weight:this.fromData.split_weight
            }).then(() => {
                Toast.success('结算成功');
                this.closed(true)
            })
