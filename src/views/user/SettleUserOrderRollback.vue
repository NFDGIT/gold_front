<template>
    <van-dialog v-model:show="isShow" title="撤销玩家订单结算" show-cancel-button @closed="closed(false)" @confirm="settleClick">
        <div class="settle_content">
            <div class="settle_card">
                ...
                <van-row>
                    <van-col span="12">
                        <span class="remark">请输入玩家姓名</span>
                    </van-col>
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;" >
                        <input v-model="fromData.user_name" @change="profitCipher" @keyup="profitCipher">
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="12">
                ...
                <van-row>
                    ...
                    <van-col span="12" calss="right" style="text-align: right;padding-right: 10px;">
                        <input v-model="fromData.finish_at" @change="profitCipher" @keyup="profitCipher">
                    </van-col>
                </van-row>
                <van-row>
                    <van-col span="12">
...
import { settleOrderDetailRollback } from '../../service/order.js'
